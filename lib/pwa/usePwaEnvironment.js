...
import {detectIOSBrowser} from './detectIOSBrowser.mjs'
...
export function usePwaEnvironment(){
 ...
 const environment=useMemo(()=>{
  ...
  const iosBrowser=detectIOSBrowser(ua,isIOS)
  ...
  return{platform:isIOS?'ios':isAndroid?'android':'desktop',isIOS,isAndroid,iosBrowser,isStandalone,supportsPush}
 },[installedByEvent])
 useEffect(()=>{
